...
acr_result = acr([tree], character=feature, states=column2states[feature], prediction_method=JOINT, model=F81)
...
class ACRStateJointEFTTest(unittest.TestCase):
    ...
    def test_collapsed_vs_full(self):
        ...
        acr([tree_uncollapsed], character=feature, states=column2states[feature], prediction_method=JOINT, model=F81)
